...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container-custom section-padding relative z-10 landscape:py-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-slide-up">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight landscape:text-3xl">
                Building
                <span className="block gradient-text text-glow">Tomorrow's</span>
                Philippines
              </h1>
              
              <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed landscape:text-lg">
            ...
            {/* Stats - Hidden on very small landscape viewports */}
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-border landscape:hidden sm:landscape:grid">
